...
public class PartnerAdminService {
    ...
    public void loadPartnerRdfToFuseki(long id, String contentType) throws IOException {
        ...
        fusekiClient.uploadRdfFile(Path.of(s.getRdfFilePath()), contentType, "urn:partner:" + id);
    }
    ...
    public void delete(long id) {
        ...
        repo.save(s);
        fusekiClient.deleteGraph("urn:partner:" + id);
    }
    ...
    public void loadMappingToFuseki(long id, String contentType) throws IOException {
        ...
        fusekiClient.uploadRdfFile(Path.of(s.getMappingFilePath()), contentType, "urn:partner:" + id);
    }
}
